...
# Interpretation:
# The LE difference vs Hale difference graph is similar to the LE vs Hale, because both have a slope in a linear function that is positive with correlation.
# The life expectancy and health adjusted life expectancy increased between the years of 1990 and 2016 - meaning that health was better, due to unexplained circumstances. This could be 
# new medicine, equipment, breakthroughs, etc. 
